...
const pricingTiers = [
  ...
  },
  {
    title: "Dynamic Web",
    price: 400000,
    features: ["Custom dynamic UI", "CMS / Backend", "Interactive UX"],
  },
  {
...
export default function Pricing() {
  usePageMeta({
    title: "Pricing",
    description:
      "Review A'Dash Technology starting rates for websites, portals, software systems, mobile apps, and AI automation projects.",
  ...
  return (
    <section className="pricing-section">
      ...
      <p className="currency-disclaimer">
        USD pricing shown for international reference only. Local billing is done
        in JMD at agreed exchange rates.
      </p>
        ...
        {pricingTiers.map((tier) => (
          <div className="pricing-card" key={tier.title}>
            ...
            <p className="pricing-price">
              {tier.price ? <>From {convert(tier.price)}</> : "Custom Quote"}
            </p>
            <ul>
      ...
      <div className="pricing-why">
        ...
        <p>
          Our rates reflect engineering-led builds, not template work. We price
          for clarity, scalability, and long-term value, so clients don&apos;t pay
          twice to fix shortcuts later.
        </p>
      ...
      <div className="pricing-retainers">
        ...
        <p>
          For active platforms and long-term systems, we offer monthly retainers
          to keep everything secure, optimized, and evolving.
        </p>
      ...
      <div className="pricing-faq">
        ...
        <div className="faq-item">
          ...
          <p>Yes. Larger projects are typically split into milestone-based payments.</p>
        </div>

        <div className="faq-item">
          <h4>Can you work with international clients?</h4>
          <p>Absolutely. We build globally while operating from Jamaica.</p>
        </div>
      </div>
